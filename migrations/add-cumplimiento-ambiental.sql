...
CREATE TABLE informe_cumplimiento_ambiental (
  ...
  tala_numero_documento TEXT,
  tala_fecha_emision DATE,
  tala_fecha_caducidad DATE,
  tala_tiene_plan_compensacion BOOLEAN,
  tala_alerta_critica BOOLEAN DEFAULT false,
  tala_cantidad_arboles INTEGER,
  tala_mecanismo_compensacion TEXT,
  tala_especies_compensacion INTEGER,
  tala_sitios_compensacion TEXT,
  -- Asbesto Cemento
